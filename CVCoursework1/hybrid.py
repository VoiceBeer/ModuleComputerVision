...
if __name__ == '__main__':
    image1 = cv2.imread('./data/cat.bmp') / 255.0
    image2 = cv2.imread('./data/dog.bmp') / 255.0
    ...
    high_frequencies = image2 * 255.0 - my_imfilter(image2, kernel, 0)
